...
public class TxzhTsBddwmlNode {
	...
	private List<TxzhTsBddwmlNode> children;
	...
	public List<TxzhTsBddwmlNode> getChildren() {
		return children;
	}

	public void setChildren(List<TxzhTsBddwmlNode> children) {
